//lọc khóa học theo hình thức (type)
//window.location.search = name = abcid = 123
...
if(type){
    //lọc theo type
    if(type == "onlab"){
        document.title = "khóa học trực tiếp";
        courseList = course.filter(c => c.type == "onlab");
    }
    else if(type == "online"){
...
//Chức năng tìm kiếm khóa học theo tên(topic)
...
//Chức năng tìm kiếm khóa học theo tên
